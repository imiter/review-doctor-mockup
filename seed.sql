...
-- ----------------------------------------------------------------------------
-- 6. reply_styles — 페르소나 5종 + 별점대별 템플릿 + 불만 리뷰 RAG용 톤 지시문
...
('찐사장님 말투', '페르소나 톤을 얹지 않고, 사장님이 학습한 진짜 말투를 그대로 반영해요.',
 '{nickname}님, {menu} 맛있게 드셨다니 감사합니다. {store}는 앞으로도 좋은 모습 보여드리겠습니다.',
 '{nickname}님, 소중한 의견 감사합니다. {menu} 관련해서 더 신경 쓰겠습니다.',
 '{nickname}님, 불편을 드려 죄송합니다. {menu} 관련 말씀 주신 부분 확인 후 개선하겠습니다.',
 '이모지 사용량이나 격식 수준을 특정 페르소나에 맞춰 임의로 바꾸지 마세요. 아래 [이 가게의 답글 스타일]에 정리된 사장님의 실제 말투와 습관을 그대로 따르세요.');
