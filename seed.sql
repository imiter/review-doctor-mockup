...
-- ----------------------------------------------------------------------------
-- 6. reply_styles — 페르소나 4종 + 별점대별 템플릿
--    플레이스홀더: {nickname}, {menu}, {store}
-- ----------------------------------------------------------------------------
INSERT INTO reply_styles (name, description, template_high, template_mid, template_low) VALUES
('발랄 이모지 파티', '발랄한 20대 여사장님 말투. 이모지를 다양하게 사용해 귀엽게 답변합니다.',
...
('진중맨', '진중한 50대 남사장님 말투. 이모지를 최소한으로 사용하고 진지하게 답변합니다.',
...
('무난 요정', '차분한 30대 여사장님 말투. 이모지를 적절히 섞어 친절하게 답변합니다.',
...
('진지한 하이개그', '농담을 좋아하고 통통 튀는 사장님 말투. 부정 리뷰에는 심한 농담을 하지 않습니다.',
